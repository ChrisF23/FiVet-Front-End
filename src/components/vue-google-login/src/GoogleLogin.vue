<template>
  <div>
    <div v-if="$props.logoutButton" @click="handleClick">Cerrar Sesion</div>
    <div v-if="!$props.logoutButton">
      <button type="button" class="google-button" @click="handleClick">
        ...
        <span class="google-button__text">Iniciar sesión con Google</span>
      </button>
    </div>
  </div>
</template>
